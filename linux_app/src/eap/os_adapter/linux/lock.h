...
public:
     ...
     * @return true:successed, false:don't waited resouce
     */
    bool timedWait(const u_int64_t timeout);
...
public:
    bool SetEvent();
    bool ResetEvent();
    u_int32_t WaitEvent(u_int32_t dwTimeout_MS);
...
private:
    ...
    volatile u_int32_t m_semCount;
};

inline u_int32_t WaitForSingleObject(CMyEvent *hEvent, u_int32_t dwMillseconds)
{
